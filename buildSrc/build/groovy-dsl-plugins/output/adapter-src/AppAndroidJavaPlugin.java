...
/**
 * Precompiled app.android.java script plugin.
 **/
public class AppAndroidJavaPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_AppAndroidJava").asSubclass(BasicScript.class);
