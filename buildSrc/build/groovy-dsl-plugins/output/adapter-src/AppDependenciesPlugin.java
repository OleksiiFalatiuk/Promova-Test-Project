...
/**
 * Precompiled app.dependencies script plugin.
 **/
public class AppDependenciesPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_AppDependencies").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("app.compose");
            target.getPluginManager().apply("app.android.java");
            target.getPluginManager().apply("module.assertion");
            target.getPluginManager().apply("com.google.firebase.firebase-perf");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_AppDependencies").asSubclass(BasicScript.class);
