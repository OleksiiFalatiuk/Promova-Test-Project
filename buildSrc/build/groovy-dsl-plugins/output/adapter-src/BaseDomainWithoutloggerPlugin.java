...
/**
 * Precompiled base.domain.withoutlogger script plugin.
 **/
public class BaseDomainWithoutloggerPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_BaseDomainWithoutlogger").asSubclass(BasicScript.class);
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_BaseDomainWithoutlogger").asSubclass(BasicScript.class);
