...
/**
 * Precompiled base.models.remote script plugin.
 **/
public class BaseModelsRemotePlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_BaseModelsRemote").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("kotlin.serialization");
            target.getPluginManager().apply("app.kotlin.java");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_BaseModelsRemote").asSubclass(BasicScript.class);
