...
/**
 * Precompiled base.presentation.withoutlogger script plugin.
 **/
public class BasePresentationWithoutloggerPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_BasePresentationWithoutlogger").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("app.baseconfig");
            target.getPluginManager().apply("app.compose");
            target.getPluginManager().apply("core.localization");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_BasePresentationWithoutlogger").asSubclass(BasicScript.class);
