...
/**
 * Precompiled core.common script plugin.
 **/
public class CoreCommonPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_CoreCommon").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("android.serialization");
            target.getPluginManager().apply("app.baseconfig");
            target.getPluginManager().apply("app.compose");
            target.getPluginManager().apply("android.paging");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_CoreCommon").asSubclass(BasicScript.class);
