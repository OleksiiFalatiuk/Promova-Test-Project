...
/**
 * Precompiled ktlint script plugin.
 **/
public class KtlintPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_Ktlint").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("org.jlleitschuh.gradle.ktlint");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_Ktlint").asSubclass(BasicScript.class);
