...
/**
 * Precompiled module.assertion script plugin.
 **/
public class ModuleAssertionPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_ModuleAssertion").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("com.jraska.module.graph.assertion");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_ModuleAssertion").asSubclass(BasicScript.class);
